...
<?= Html::beginForm('', 'post', ['enctype' => 'multipart/form-data', 'id' => 'efficiency-form']) ?>

	<div class="row">
		<div class="col-md-6 col-lg-3">
			<?= Html::label('Mantenance Type', '', ['class' => 'mt-2']) ?>
			<?= Select2::widget([
				    'name' => 'mnt_type_id[]',
				    'items' => $mnt_types,
				    'clientOptions' => [
	...
	<?= Html::a(
	    ...
	    " Get efficiencyActivities as excel", ['total-efficiency'], 
	    [
	        'onClick'=>'makePostRequest(event,"efficiency-form")',
