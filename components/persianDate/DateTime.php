...
class DateTime
{
	...
	private function getTime($string = null){
		return $string ? strtotime($string) : time();
	}

	public function JalaliDate($string = null){
		return $this->date('Y/m/d', $this->getTime($string));
	}

	public function jalaliDateTime($string = null){
		return $this->date('Y/m/d H:i:s', $this->getTime($string));
	}
}
