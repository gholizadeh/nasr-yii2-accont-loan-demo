...
(function () {
    ...
    var persianDatepicker = (function () {
        function persianDatepicker(element, userOptions) {
            ...
            self.cal_footerStyle = "style='height:" + _ch + "px;line-height:" + _ch + "px; font-size:" + _fontSize + "px;' ";
        ...
        persianDatepicker.prototype = {
            ...
            cal_footer: function () {
                var self = this;
                _cal_footer = $('<div class="cal_footer" ' + self.cal_footerStyle + ' />');
                _cal_footer.appendTo(this.calendar);
